...
$GLOBALS['TL_LANG']['ERR']['linkToNotExistingFile'] = 'The database entry for the image with ID %s in "tl_gallery_creator_pictures" refers to a file that does not exist. Please clean up the database or verify the existence of the file "%s" in the album with the album alias "%s".';
