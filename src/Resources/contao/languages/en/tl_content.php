...
$GLOBALS['TL_LANG']['tl_content']['gcTemplate'] = ['Gallery template', 'Select a personal gallery template.'];
...
$GLOBALS['TL_LANG']['tl_content']['gcSortingField']['comment'] = "Comment/Caption (comment)";
