...
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['image_info'] = ['Image-informations'];
...
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['name'] = ['Filename'];
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['addCustomThumb'] = ['Add a custom thumbnail'];
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['customThumb'] = ['Custom thumbnail.'];
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['title'] = ['Image title'];
$GLOBALS['TL_LANG']['tl_gallery_creator_pictures']['comment'] = ['Image-comment'];
