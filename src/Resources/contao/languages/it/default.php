...
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthentificationError'][0] = 'Errore di autenticazione';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthentificationError'][1] = 'Hai cercato di accedere a un album protetto. Prego effettua il login come utente frontend o controlla i tuoi permessi.';
