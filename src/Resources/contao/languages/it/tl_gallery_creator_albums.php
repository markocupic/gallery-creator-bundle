...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['caption'][0] = 'captiono album';
...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['uploadImages'][0] = 'Carica immagini';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['uploadImages'][1] = "Carica immagini all'album con ID %s";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImagesFromFilesystem'][0] = 'Copia le immagini da una directory sul server';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImagesFromFilesystem'][1] = "Copia le immagini da una directory sul server nell'album con ID %s";
