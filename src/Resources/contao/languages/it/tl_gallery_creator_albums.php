...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImages']['0'] = 'Copia le immagini da una directory sul server';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImages']['1'] = "Copia le immagini da una directory sul server nell'album con ID %s";
