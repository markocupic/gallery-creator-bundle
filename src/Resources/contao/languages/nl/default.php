...
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthentificationError'][0] = 'Authentification error';
$GLOBALS['TL_LANG']['GALLERY_CREATOR']['feAuthentificationError'][1] = 'U probeerde een beschermd album binnen te gaan. Log-in als frontend gebruiker of check uw rechten.';
