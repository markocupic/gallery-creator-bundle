...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['caption'][0] = 'Opmerkingen album';
...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['uploadImages'][0] = 'Upload bestanden';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['uploadImages'][1] = 'Upload afbeeldingen naar album ID %s.';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImagesFromFilesystem'][0] = 'Kopieer afbeeldingen vanuit een map op de server';
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImagesFromFilesystem'][1] = 'Kopieer afbeeldingen vanuit een map op de server naar album ID %s.';
