...
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImages']['0'] = "Kopieer afbeeldingen vanuit een map op de server";
$GLOBALS['TL_LANG']['tl_gallery_creator_albums']['importImages']['1'] = "Kopieer afbeeldingen vanuit een map op de server naar album ID %s.";
