...
final class GalleryCreatorAlbumPermissions
{
     ...
     */
    public const string USER_CAN_EDIT_ALBUM = 'contao_gallery_creator_user.can_edit_album';

    /**
     * Access is granted if the current user can add child albums to the current album.
     * Subject must be an album ID.
     */
    public const string USER_CAN_ADD_CHILD_ALBUMS = 'contao_gallery_creator_user.can_add_child_albums';

    /**
     * Access is granted if the current user can delete a certain album.
     * Subject must be an album ID.
     */
    public const string USER_CAN_DELETE_ALBUM = 'contao_gallery_creator_user.can_delete_album';

    /**
     * Access is granted if the current user can change the hierarchy of albums.
     * Subject must be an album ID.
     */
    public const string USER_CAN_MOVE_ALBUM = 'contao_gallery_creator_user.can_move_album';

    /**
     * Access is granted if the current user can add and edit images inside a certain album.
     * Subject must be an album ID.
     */
    public const string USER_CAN_ADD_AND_EDIT_IMAGES = 'contao_gallery_creator_user.can_add_and_edit_images';

    /**
     * Access is granted if the current user can delete images inside a certain album.
     * Subject must be an album ID.
     */
    public const string USER_CAN_DELETE_IMAGES = 'contao_gallery_creator_user.can_delete_images';

    /**
     * Access is granted if the current user can move images inside a certain album.
     * Subject must be an album ID.
     */
    public const string USER_CAN_MOVE_IMAGES = 'contao_gallery_creator_user.can_move_images';
}
